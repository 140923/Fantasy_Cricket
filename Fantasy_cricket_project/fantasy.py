...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(863, 750)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(20, 60, 801, 91))
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(20, 170, 311, 91))
        ...
        self.label.setGeometry(QtCore.QRect(300, 630, 191, 41))
        font = QtGui.QFont()
    ...
    def menufunction(self,action):
        ...
        if txt=='SAVE Team':
            if self.total_pl<11:                  
                self.showdlg("The team must consist of 11 players")  
            else:
                sql="SELECT name FROM teams;"
                try:
                    cur.execute(sql)
        ...
        if txt=='OPEN Team':
            ...
            try:
                ...
                item,ok = QtWidgets.QInputDialog.getItem(MainWindow, "OpenTeam", 
                 "Select any team to open",teamnames,0,False)                   
    ...
    def display_msg(self,text):
        ...
        if self.bat>=4 and ctg=="BAT":
            self.flag=0
            self.showdlg("There can't be more than 4 batsmen")
        if self.bwl>=3 and ctg=="BWL":
            self.flag=0
            self.showdlg("There can't be more than 3 bowlers")
        if self.wk>=1 and ctg=="WK":
            self.flag=0
            self.showdlg("There can't be more than 1 wicketkeeper")
        if self.ar>=3 and ctg=="AR":
            self.flag=0
            self.showdlg("There can't be more than 3 alrounder")
